...
object RuLocale : Locale() {
    override val start = "Привет! Меня зовут *PrizeBot*," +
    ...
    override val giveawayTitleMaxLen = "Максимальная длина для названия розыгрыша - $MAX_TITLE_LEN символов, попробуй ещё раз"

    override val send = "Отправить..."

    override fun participateButton(text: String) = "Кнопка участия: $text"
    ...
    override val unknownUserDeletedUsername = "Неизвестен (пользователь удалил юзернейм)"
